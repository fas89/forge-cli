...
"""CLI command to generate transformation engine artifacts from FLUID contracts.

Auto-detects the engine from ``builds[].engine`` in the contract.

Usage:
    fluid generate                              # discover contract + engine
    fluid generate contract.fluid.yaml          # specify contract
    fluid generate contract.fluid.yaml -o ./out # specify output dir
    fluid generate --list                       # show available engines
"""
...
def register(subparsers: argparse._SubParsersAction):
    ...
    p = subparsers.add_parser(
        COMMAND,
        help="Generate transformation artifacts from FLUID contract",
        description="""
...
Examples:
  ...
  fluid generate contract.fluid.yaml -o ./dbt_project
...
def _list_engines() -> int:
    ...
    cprint("\nUsage: fluid generate [contract.fluid.yaml]")
...
def _print_summary(output_dir: Path, files: Dict[str, str], engine_name: str) -> None:
    ...
    cprint(f"\nTip: To regenerate after editing the contract: fluid generate")
