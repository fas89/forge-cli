...
from .core import FluidCLIError, CLIContext
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "memory_growth_mb": (
                ...
                if self.peak_memory_mb and self.initial_memory_mb else None
            ),
    ...
    def get_stats(self) -> Dict[str, Optional[float]]:
        ...
        return {
            ...
            'growth_mb': (
                ...
                if self._peak_memory and self._initial_memory else None
            )
        }
