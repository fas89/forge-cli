...
def validate_project_name(name: str) -> Tuple[bool, Optional[str]]:
    ...
    if not re.match(r'^[a-z][a-z0-9-]*[a-z0-9]$', name):
        return False, "Project name must start with a letter, end with letter/number, and contain only lowercase letters, numbers, and hyphens"
...
def validate_template_name(template: str) -> Tuple[bool, Optional[str]]:
    ...
    if not re.match(r'^[a-z][a-z0-9-]*$', template):
        return False, "Template name must start with a letter and contain only lowercase letters, numbers, and hyphens"
