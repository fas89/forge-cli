...
from ..core.interfaces import ProjectTemplate, InfrastructureProvider, GenerationContext, TemplateMetadata
from ..core.registry import get_template_registry, get_provider_registry
...
class TemplateTestSuite:
    ...
    def _test_generation(self, template: ProjectTemplate, config: Dict[str, Any], target_path: Path) -> Tuple[List[str], List[str]]:
