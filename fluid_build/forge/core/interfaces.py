...
class Extension(ABC):
    ...
    def on_provider_configured(self, provider: InfrastructureProvider, context: GenerationContext) -> None:
    ...
    def modify_prompts(self, prompts: List[Dict[str, Any]], context: GenerationContext) -> List[Dict[str, Any]]:
...
class ComponentFactory:
    ...
    @staticmethod
    def create_file_generator(templates: Dict[str, str], template_dir: Optional[Path] = None) -> FileGenerator:
