...
class GCPProvider(InfrastructureProvider):
    ...
    def get_metadata(self) -> Dict[str, Any]:
        return {
            ...
            'supported_services': ['bigquery', 'dataflow', 'cloud-functions', 'composer', 'vertex-ai'],
    ...
    def configure_interactive(self, context: GenerationContext) -> Dict[str, Any]:
        ...
        config['dataset'] = Prompt.ask("BigQuery Dataset", default=context.project_config.get('name', 'dataproduct'))
