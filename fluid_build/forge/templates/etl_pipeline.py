            ...
            'exposes': [
                {
                    ...
                    'schema': [
                        ...
                        {'name': 'order_amount', 'type': 'decimal', 'description': 'Total order amount', 'nullable': False},
                        {'name': 'order_date', 'type': 'date', 'description': 'Date when order was placed', 'nullable': False}
                    ],
                    'quality': [
                        {
