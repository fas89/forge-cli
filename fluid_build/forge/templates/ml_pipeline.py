            ...
            'exposes': [
                {
                    ...
                    'schema': [
                        {'name': 'record_id', 'type': 'string', 'description': 'Unique record identifier', 'nullable': False},
                        {'name': 'prediction', 'type': 'float', 'description': 'Model prediction value', 'nullable': False},
                        {'name': 'confidence_score', 'type': 'float', 'description': 'Prediction confidence score', 'nullable': True},
                        {'name': 'model_version', 'type': 'string', 'description': 'Version of the model used', 'nullable': False},
                        {'name': 'predicted_at', 'type': 'timestamp', 'description': 'Prediction timestamp', 'nullable': False}
                    ],
                    'quality': [
                        {
