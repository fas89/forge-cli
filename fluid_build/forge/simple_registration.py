...
if TYPE_CHECKING:
    from .core.simple_registry import TemplateRegistry, ProviderRegistry, ExtensionRegistry, GeneratorRegistry
...
def register_all_components(templates, providers, extensions, generators):
    ...
    logger.info(f"Registered {template_count} templates, {provider_count} providers, {extension_count} extensions, {generator_count} generators")
