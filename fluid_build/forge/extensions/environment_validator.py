...
class EnvironmentValidatorExtension(Extension):
    ...
    def _validate_analytics_environment(self) -> None:
        ...
        if missing_analytics:
            rprint(f"[yellow]💡 Consider installing analytics tools: {', '.join(missing_analytics)}[/yellow]")
    ...
    def _validate_ml_environment(self) -> None:
        ...
        try:
            ...
            rprint("[yellow]💡 Consider installing ML libraries: scikit-learn, numpy, pandas[/yellow]")
