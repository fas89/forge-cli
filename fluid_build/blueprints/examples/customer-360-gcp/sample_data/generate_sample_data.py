    ...
    for customer in customers:
        ...
        for _ in range(num_transactions):
            ...
            if days_since_signup > 0:
                transaction_date = customer_since + timedelta(days=random.randint(1, days_since_signup))
            else:
...
if __name__ == "__main__":
    ...
    customer_fieldnames = [
        ...
        'date_of_birth', 'gender', 'customer_since', 'customer_status',
    ...
    transaction_fieldnames = [
        'transaction_id', 'customer_id', 'order_id', 'transaction_date',
        'transaction_timestamp', 'amount', 'currency', 'payment_method',
        'transaction_type', 'status', 'product_category', 'product_id',
        'quantity', 'unit_price', 'channel', 'created_at', 'updated_at'
    ]
    save_to_csv(transactions, 'transactions_full.csv', transaction_fieldnames)
    
    cprint(f"Sample data generation completed!")
