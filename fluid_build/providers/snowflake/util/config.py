...
def resolve_account_and_warehouse(
    ...
    try:
        ...
        warehouse = warehouse or os.environ.get("SNOWFLAKE_WAREHOUSE") or os.environ.get("SF_WAREHOUSE") or "COMPUTE_WH"
...
def get_connection_params(
    ...
    **kwargs
    ...
    """
    try:
        from fluid_build.credentials import get_snowflake_adapter
        from fluid_build.credentials import CredentialConfig
        ...
        return _get_connection_params_legacy(
            account, warehouse, database, schema, user, **kwargs
        )
