    ...
    try:
        ...
        try:
            ...
            return {
                ...
                "message_retention_duration": existing_topic.message_retention_duration.seconds if existing_topic.message_retention_duration else None,
                "duration_ms": duration_ms(start_time),
                "changed": changed,
            }
            ...
            return {
                ...
                "message_retention_duration": created_topic.message_retention_duration.seconds if created_topic.message_retention_duration else None,
                "duration_ms": duration_ms(start_time),
                "changed": True,
            }
...
def ensure_subscription(action: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            existing_subscription = subscriber.get_subscription(request={"subscription": subscription_path})
            
            # Compare and update if necessary
            update_mask = []
            
            # Check labels
            existing_labels = dict(existing_subscription.labels) if existing_subscription.labels else {}
            if existing_labels != labels:
