...
def ensure_bucket(action: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        try:
            ...
            if bucket.iam_configuration.uniform_bucket_level_access_enabled != uniform_bucket_level_access:
            ...
            if blob.exists():
                if source_path:
                    ...
                    try:
                        ...
                        if (blob.updated and 
                            blob.size == stat.st_size and 
                            blob.updated.timestamp() >= stat.st_mtime):
                            changed = False
                    except OSError:
    ...
    try:
        ...
        try:
            ...
            if dest_blob.exists():
                ...
                if (source_blob.md5_hash == dest_blob.md5_hash and 
                    source_blob.size == dest_blob.size):
                    changed = False
