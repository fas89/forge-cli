...
from fluid_build.policy.sovereignty import (
    EnforcementMode, SovereigntyViolation, SovereigntyValidator,
    validate_sovereignty, get_region_jurisdiction,
)
...
class TestSovereigntyViolation:
    ...
    def test_full(self):
        v = SovereigntyViolation(
            ...
            expose_id="e1", region_found="us-east-1",
            region_expected=["eu-west-1"], suggestion="move it",
        )
...
class TestSovereigntyValidator:
    ...
    def test_audit_mode_passes(self):
        ok, _ = SovereigntyValidator().validate(self._contract(
    ...
    def test_jurisdiction_mismatch_warning(self):
        ...
        assert any(v.severity == "warning" and "jurisdiction" in v.message.lower() for v in violations)
