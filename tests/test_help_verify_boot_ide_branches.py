...
class TestValidateContractObj:
    ...
    def test_fallback_valid(self, mock_imp):
        ...
        mock_imp.return_value = mock_mod
        contract = {
            "fluidVersion": "0.5.7", "kind": "DataContract",
            "id": "test", "name": "Test", "metadata": {}
        }
...
class TestPlanContract:
    ...
    def test_fallback_file_format(self, tmp_path):
        ...
        contract = {
            "exposes": [{
                "location": {"format": "file", "properties": {}}
            }]
        }
...
class TestCompletionItem:
    def test_create(self):
        ...
        ci = CompletionItem(
            ...
            detail="Validate", documentation="Validate contract",
...
class TestDiagnosticItem:
    def test_create(self):
        ...
        di = DiagnosticItem(
            file_path="/tmp/test.yaml", line=10, column=5,
...
class TestFluidLanguageServer:
    ...
    def test_completion_data_items_are_completion_items(self):
        from fluid_build.cli.ide import FluidLanguageServer, CompletionItem
        ls = FluidLanguageServer()
